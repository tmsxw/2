 ...
 *
 * Translation tables expanded for XenForo.
 */
...
if(!function_exists('utf8_substr')){
    ...
    function utf8_substr($str, $offset, $length = null) {
        ...
        if ($offset < 0) {
            $strlen = strlen(mb_convert_encoding($str, 'ISO-8859-1', 'UTF-8'));        // see notes
        ...
        if (is_null($length)) {
            ...
            if (!isset($strlen)) $strlen = strlen(mb_convert_encoding($str, 'ISO-8859-1', 'UTF-8'));    // see notes
...
if(!class_exists('utf8_entity_decoder')){
    ...
    class utf8_entity_decoder {
        ...
        function __construct() {
	        ...
	        # XenForo modification - encoding changed in PHP 5.4 and the array_map call is now unneccessary
