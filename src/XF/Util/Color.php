...
class Color
{
	...
	public static function hslToRgb($h, $s = null, $l = null)
	{
		...
		else
		{
			...
			$r = 255 * static::hueToRgb($t1, $t2, $h + (1 / 3));
			$g = 255 * static::hueToRgb($t1, $t2, $h);
			$b = 255 * static::hueToRgb($t1, $t2, $h - (1 / 3));
		}
	...
	public static function isValidColor($color)
	{
		...
		if (array_key_exists(utf8_strtolower($color), static::$namedColors))
		{
			return true;
		}
